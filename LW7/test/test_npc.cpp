...
TEST(constructors_and_gettings, test)
{
    ...
    ASSERT_EQ(npc.status, expected_alive);
    ASSERT_EQ(new_npc.status, expected_alive);
    ASSERT_EQ(another_npc.status, expected_alive);
    ASSERT_EQ(copied_npc.status, expected_alive);
    ASSERT_EQ(moved_npc.status, expected_alive);
}
